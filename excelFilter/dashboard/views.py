...
def index(request):
    context = {
        ...
        'dashboard_overall_summary_today': utils.get_dashboard_overall_summary_today(),
        'dashboard_controller_summary_today': utils.get_dashboard_controller_summary_today(),
        'controller_total_today': utils.get_controller_total_today()
    }
...
def _emailForActionFollowUp(request, menu_slug):
    ...
    context = utils.update_context(menu_slug, context)
